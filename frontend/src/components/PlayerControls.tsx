  ...
  return (
    <div className="flex flex-col items-center gap-1 w-full max-w-[600px]">
      ...
      <div className="flex items-center gap-2 w-full">
        ...
        <div
          ref={progressBarRef}
          className="relative flex-1 h-1 bg-surface-highlight rounded-full cursor-pointer group"
          onMouseDown={handleMouseDown}
        >
          <div
            className="absolute left-0 top-0 h-full bg-primary rounded-full group-hover:bg-spotify-green transition-colors"
